...
from NekoRobot.modules.sql.afk_redis import is_user_afk, afk_reason
...
from NekoRobot import telethn as NekoTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'Yùki Network'."
        disaster_level_present = True
